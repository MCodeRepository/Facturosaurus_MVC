...
{
    public class ModifyCustomerCommandHandler : IRequestHandler<ModifyCustomerCommand>
    {
        private readonly ICustomerRepository _customerRepository;
        private readonly IMapper _mapper;

        public ModifyCustomerCommandHandler(IMapper mapper, ICustomerRepository customerRepository)
        {
            _customerRepository = customerRepository;
            _mapper = mapper;
        }

        public async Task<Unit> Handle(ModifyCustomerCommand request, CancellationToken cancellationToken)
        {
