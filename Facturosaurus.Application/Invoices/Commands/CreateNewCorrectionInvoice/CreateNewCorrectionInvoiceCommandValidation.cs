...
{
    public class CreateNewCorrectionInvoiceCommandValidation : AbstractValidator<CreateNewCorrectionInvoiceCommand>
    {
        public CreateNewCorrectionInvoiceCommandValidation(ICustomerRepository repository)
        {
            ...
            RuleForEach(c => c.Items).SetValidator(new InvoiceCorrectionItemDtoValidation());
        }
    }

    public class InvoiceCorrectionItemDtoValidation : AbstractValidator<InvoiceItemDto>
    {
        public InvoiceCorrectionItemDtoValidation()
        {
